...
![_config.yml]({{ site.baseurl }}/images/smiley.jpg)

Check my repo [Hang's repository](https://github.com/lihaa) for more code! I might have some implementations and experiments there.
